...
from data.mm_data.segmentation_semi_dataset import SegmentationSemiDataset
...
@dataclass
class SegmentationSemiConfig(OFAConfig):
    eval_acc: bool = field(
...
class SegmentationSemiTask(OFATask):
    def __init__(self, cfg: SegmentationSemiConfig, src_dict, tgt_dict):
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        self.datasets[split] = SegmentationSemiDataset(
            split,
            dataset,
            dataset_labeled,
            self.bpe,
