...
@dataclass
class CustomVqaGenConfig(OFAConfig):
...
@register_task("custom_vqa_gen", dataclass=CustomVqaGenConfig)
class CustomVqaGenTask(OFATask):
    def __init__(self, cfg: CustomVqaGenConfig, src_dict, tgt_dict):
