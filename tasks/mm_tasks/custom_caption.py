...
from data.mm_data.custom_caption_dataset import CustomCaptionDataset
...
@dataclass
class CustomCaptionConfig(OFAConfig):
...
@register_task("custom_caption", dataclass=CustomCaptionConfig)
class CustomCaptionTask(OFATask):
    def __init__(self, cfg: CustomCaptionConfig, src_dict, tgt_dict):
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        self.datasets[split] = CustomCaptionDataset(
            split,
            dataset,
            self.bpe,
            self.src_dict,
