...
@register_model("segofa_semi_masked")
class SegOFASemiMaskedModel(TransformerModel):
    ...
    @staticmethod
    def add_args(parser):
        super(SegOFASemiMaskedModel, SegOFASemiMaskedModel).add_args(parser)
        parser.add_argument(
            "--pooler-dropout",
            type=float,
            metavar="D",
...
@register_model_architecture("segofa_semi_masked", "segofa_semi_masked_large")
def segofa_semi_masked_large_architecture(args):
...
@register_model_architecture("segofa_semi_masked", "segofa_semi_masked_sbase")
def segofa_semi_masked_base_architecture(args):
    ...
    segofa_semi_masked_large_architecture(args)


@register_model_architecture("segofa_semi_masked", "segofa_semi_masked_huge")
def segofa_semi_masked_huge_architecture(args):
...
@register_model_architecture("segofa_semi_masked", "segofa_semi_masked_medium")
def segofa_semi_masked_medium_architecture(args):
...
@register_model_architecture("segofa_semi_masked", "segofa_semi_masked_tiny")
def segofa_semi_masked_architecture(args):
