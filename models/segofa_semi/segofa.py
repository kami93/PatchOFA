...
@register_model("segofa_semi")
class SegOFASemiModel(TransformerModel):
    ...
    @staticmethod
    def add_args(parser):
        super(SegOFASemiModel, SegOFASemiModel).add_args(parser)
        parser.add_argument(
            "--pooler-dropout",
            type=float,
            metavar="D",
    ...
    def forward(
        ...
        labeled_input: Optional[dict] = None
    ):
...
@register_model_architecture("segofa_semi", "segofa_semi_large")
def segofa_semi_large_architecture(args):
...
@register_model_architecture("segofa_semi", "segofa_semi_base")
def segofa_semi_base_architecture(args):
    ...
    segofa_semi_large_architecture(args)


@register_model_architecture("segofa_semi", "segofa_semi_huge")
def segofa_semi_huge_architecture(args):
...
@register_model_architecture("segofa_semi", "segofa_semi_medium")
def segofa_semi_medium_architecture(args):
...
@register_model_architecture("segofa_semi", "segofa_semi_tiny")
def segofa_semi_architecture(args):
