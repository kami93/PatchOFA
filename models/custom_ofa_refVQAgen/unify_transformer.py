...
@register_model("ofa_refvqagen_unify_transformer")
...
class TransformerEncoder(FairseqEncoder):
    ...
    def forward(
        ...
        word_batch_idx: Optional[torch.Tensor] = None,
    ...
    def forward_scriptable(
        ...
        token_embeddings: Optional[torch.Tensor] = None,
        sample_patch_num: Optional[int] = None,
        word_batch_idx: Optional[int] = None
    ):
        """
        Args:
            src_tokens (LongTensor): tokens in the source language of shape
        ...
        #######
        image_embed = image_embed[word_batch_idx]
        image_padding_mask = image_padding_mask[word_batch_idx]
        image_position_ids = image_position_ids[word_batch_idx]
        image_pos_embed = image_pos_embed[word_batch_idx]
        #######
...
@register_model_architecture("ofa_refvqagen_unify_transformer", "ofa_refvqagen_unify_transformer")
