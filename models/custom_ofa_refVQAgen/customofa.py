...
@register_model("ofa_refvqagen")
class CustomOFAModel(TransformerModel):
    ...
    @staticmethod
    def add_args(parser):
        super(CustomOFAModel, CustomOFAModel).add_args(parser)
        parser.add_argument(
            "--pooler-dropout",
            type=float,
            metavar="D",
...
@register_model_architecture("ofa_refvqagen", "ofa_refvqagen_large")
def customofa_large_architecture(args):
...
@register_model_architecture("ofa_refvqagen", "ofa_refvqagen_base")
def customofa_base_architecture(args):
    ...
    customofa_large_architecture(args)


@register_model_architecture("ofa_refvqagen", "ofa_refvqagen_huge")
def customofa_huge_architecture(args):
...
@register_model_architecture("ofa_refvqagen", "ofa_refvqagen_medium")
def customofa_medium_architecture(args):
...
@register_model_architecture("ofa_refvqagen", "ofa_refvqagen_tiny")
def customofa_tiny_architecture(args):
